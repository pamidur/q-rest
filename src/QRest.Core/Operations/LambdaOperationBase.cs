...
namespace QRest.Core.Operations
{
    public abstract class LambdaOperationBase : QueryOperationBase
    {
        protected override Expression CreateExpression(ParameterExpression root, Expression context, Type element, bool queryable, IReadOnlyList<Expression> arguments, IAssemblerContext assembler)
        {
            ...
            return CreateExpression(root, context, element, queryable, (LambdaExpression)arg, assembler);
        }

        protected abstract Expression CreateExpression(ParameterExpression root, Expression context, Type element, bool queryable, LambdaExpression argument, IAssemblerContext assembler);
