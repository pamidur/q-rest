...
namespace QRest.Core.Operations
{
    ...
    {       
        protected override Expression CreateExpression(Expression context, Type element, IReadOnlyList<Expression> arguments, IAssembler assembler)
        {
            ...
            return CreateExpression(context, element, (LambdaExpression)arg, assembler);
        }

        protected abstract Expression CreateExpression(Expression context, Type element, LambdaExpression argument, IAssembler assembler);
